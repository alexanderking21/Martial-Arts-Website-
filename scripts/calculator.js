...
function input(x) {
    ...
    if (document.getElementById('desimalVar').value == 0) {
        x += y * 10; //Multiply the text input bny 10 and add value of x.
        ...
        let decimalCount = (parseIntdocument.getElementById('decimalVar').value);
...
function equals() {
    ...
    document.getElementById9('operand').value = "";
    document.getElementById('equivalent').value = 1;
}
